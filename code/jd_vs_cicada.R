...
#Plotting eno River    
plot(cicada_noise$jd[cicada_noise$site == "eno"], cicada_noise$sound_level[cicada_noise$site == "eno"], xlab = "Julian Day", ylab = "Cicada Amplitude", ylim = c(0, 1.0), xlim = c(130,185), type = 'b', col = 'red', cex = 1, pch = 25, lwd = 2)
